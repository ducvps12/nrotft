...
public class Zone {
    ...
    public void addPlayer(Player player) {
        if (player != null) {
            ...
            if (!player.isBoss && !player.isNewPet && !player.isPet && !player.isClone && !this.players.contains(player)
                    && !(player instanceof NonInteractiveNPC)) {
            ...
            synchronized (itemMap) {
                if (!itemMap.isPickedUp) {
                    if (itemMap != null && itemMap.itemTemplate != null) {
                        ...
                        int playerId = Math.abs(itemMap.playerId > 100_000_000
                                ? 1_000_000_000 - (int) itemMap.playerId
                        ...
                        if (playerId == player.id || itemMap.playerId == player.id || itemMap.playerId == -1) {
                            ...
                            if (InventoryService.gI().addItemBag(player, item)) {
                                ...
                                try {
                                    ...
                                    switch (itemType) {
                                        case 9, 10, 34 -> {
                                            msg.writer().writeUTF(item.quantity > Short.MAX_VALUE
                                    ...
                                    if (picked && itemMap.itemTemplate.id != 74 && itemMap.itemTemplate.id != 78) {
