...
public class EffectSkillService {
    ...
    public void setBienHinh(Player player) {
        ...
        player.effectSkill.timeBienHinh = SkillUtil.getTimeBienHinh(player.effectSkill.levelBienHinh);
        player.effectSkill.lastTimeBienHinh = System.currentTimeMillis();

        int forcedCoolDown = 360000;
        if (!lastLevel) {
            player.playerSkill.skillSelect.coolDown = forcedCoolDown * 5 / 100;
        } else {
            player.playerSkill.skillSelect.coolDown = forcedCoolDown;
        }
    }
    ...
    public void downBienHinh(Player player) {
        ...
        if (!lastLevel) {
            ...
            sBienHinh.coolDown = 360000 - nowTime;
