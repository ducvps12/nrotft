...
public class HoaHong extends Npc {
    ...
    private void haiHoaHong(Player player) {
        if (InventoryService.gI().getCountEmptyBag(player) < 1) {
            Service.gI().sendThongBaoOK(player, "Cần 1 ô hành trang trống");
            return;
        }
        ...
        Service.gI().sendThongBao(player, " " + hoaHong.template.name + " đẹp quá, đem đi tặng người yêu bao hợp lí");
