                ...
                switch (select) {
                    case 0 -> {
                        ...
                        if (boHoaHong1 == null && boHoaHong2 == null) {
                            Service.gI().sendThongBaoOK(player, "Anh kiếm hoa tặng em đi <3 yêu yêu");
                            return;
                        }
                        if (InventoryService.gI().getCountEmptyBag(player) < 1) {
                            Service.gI().sendThongBaoOK(player, "Cần 1 ô hành trang trống trở lên anh yêu!!!");
                            return;
                        }
                        ...
                        if (utils.Util.isTrue(5, 100)) {
                           ...
                           Service.gI().sendThongBao(player, "Yêu anh, tặng anh " + caiTrang.template.name);
                            ...
                            Service.gI().sendThongBao(player, "Yêu anh, tặng anh " + thuCung.template.name);
                        } else if (utils.Util.isTrue(25, 100)) {
                            ...
                            Service.gI().sendThongBao(player, "Yêu anh, tặng anh " + deoLung.template.name);
                        } else if (utils.Util.isTrue(25, 100)) {
                          ...
                          Service.gI().sendThongBao(player, "Yêu anh, tặng anh " + money[0] + " vàng");
                           ...
                           Service.gI().sendThongBao(player, "Yêu anh, tặng anh " + money[1] + " ngọc hồng");
                        } else {
                            player.inventory.gem += money[2];
                            Service.gI().sendThongBao(player, "Yêu anh, tặng anh " + money[2] + " ngọc xanh");
                        }
                    ...
                    case 1 -> {
                        ...
                        if (keoTiaHoa == null) {
                          Service.gI().sendThongBao(player, "Tìm mua cho em cái kéo để cắt hoa đi");
                            return;
                        }

                        if (hoaHong == null) {
                         Service.gI().sendThongBao(player, "Anh làm gì có bông hồng nào mà đưa em");
                            return;
                        }
                        if (InventoryService.gI().getCountEmptyBag(player) < 1) {
                           Service.gI().sendThongBaoOK(player, "Cần 1 ô hành trang trống trở lên anh yêu!!!");
                        ...
                        if (hoaHong.quantity > 10) {
                           ...
                           Service.gI().sendThongBao(player, " " + boHoaHong.template.name + " đẹp quá, anh có thể tặng em được không?");
                           Service.gI().sendMoney(player);
                            InventoryService.gI().sendItemBag(player);
                        } else {
                            Service.gI().sendThongBao(player, "Em cần khoàng 7 đến 10 bông hoa hồng");
                        }
