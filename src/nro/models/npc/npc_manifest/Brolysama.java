                        ...
                        if (player.getSession() != null) {
                            this.createOtherMenu(player, 13000,
                                    "\b|1|Có tiền rồi đổi thôi!\n|3|"
                                            ...
                                            + "-HP:" + player.pointfusion.getHpFusion() + " ,KI:"
                                            + player.pointfusion.getMpFusion() + " ,DAME:"
                    ...
                    case 0:
                        ...
                        if (player.getSession() != null && player.getSession().cash < 20000) {
                            NpcService.gI().createBigMessage(player, avartar,
                                    "Bạn chưa nạp 20K, bạn có muốn nạp để mở thành viên không ?!!!", (byte) 1, "NẠP",
                                    "https://dragonball.online/nap-atm.php");
                            return;
                        }
