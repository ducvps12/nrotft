...
public class LunarNewYear extends Event {
    ...
    private Item getRandomCayNeuThuong(Player player) {
        ...
        if (randomChoice <= 15) {
            ...
            item.itemOptions.add(new Item.ItemOption(95 + rand, (rand == 3 || rand == 4) ? 3 : 5)); // Tùy chỉnh option
                                                                                                    // cho Sao pha lê
            ...
            if (Util.isTrue(95, 100)) {
                int quantity = Util.nextInt(0, 3) == 0 ? 3
                        : (Util.nextInt(0, 3) == 1 ? 7 : (Util.nextInt(0, 3) == 2 ? 14 : 30));
    ...
    private Item getRandomCayNeuVip(Player player) {
        ...
        switch (randomChoice) {
            ...
            case 1:
                ...
                short selectedItemId1 = Util.nextInt(0, 2) == 0 ? (short) 1550
                        : (Util.nextInt(0, 2) == 1 ? (short) 1551 : (short) 1762);
