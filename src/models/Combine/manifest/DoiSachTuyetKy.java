...
public class DoiSachTuyetKy {
    ...
    public static void showCombine(Player player) {
        ...
        text.append(quantityCuonSachCu >= 10 ? ConstFont.BOLD_BLUE : ConstFont.BOLD_RED).append("Cuốn sách cũ ")
                .append(quantityCuonSachCu).append("/10\n");
        text.append(quantityKimBamGiay >= 1 ? ConstFont.BOLD_BLUE : ConstFont.BOLD_RED).append("Kìm bấm giấy ")
                .append(quantityKimBamGiay).append("/1\n");
        text.append(quantityCuonSachCu < 10 || quantityKimBamGiay < 1 ? ConstFont.BOLD_RED : ConstFont.BOLD_BLUE)
                .append("Tỉ lệ thành công: 20%\n");
    ...
    public static void doiSachTuyetKy(Player player) {
        ...
        if (Util.isTrue(20, 100)) {
            ...
            short itemId = switch (player.gender) {
                case 0 -> 1044;
                case 1 -> 1211;
                default -> 1042;
            };

            Item sachTuyetKy = ItemService.gI().createNewItem(itemId);
