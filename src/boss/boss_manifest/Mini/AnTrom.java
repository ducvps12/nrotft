    ...
    public void attack() {
        ...
        try {
            ...
            if (Util.getDistance(this, pl) <= 40) {
                ...
                if (!Util.canDoWithTime(this.lastTimeAnTrom, 500)
                        || goldAnTrom > 10_000_000_000L) {
                    return;
                }
    ...
    public void reward(Player plKill) {
        if (this.stolenItemCount > 0) {
            for (int i = -10; i <= 100; i += 10) {
                ...
                ItemMap item = new ItemMap(this.zone, 190, goldForThisItem, this.location.x + i,
    ...
    public void update() {
        ...
        if (this.zone != null) {
            ...
            if (playerCount > 0) {
                ...
                if (ramdonPlayer != null && ramdonPlayer.zone != null
                        && ramdonPlayer.zone.isKhongCoTrongTaiTrongKhu()) {
                    if (ramdonPlayer.zone.map.mapId != 51 && ramdonPlayer.zone.map.mapId != 113
                            && ramdonPlayer.zone.map.mapId != 129
