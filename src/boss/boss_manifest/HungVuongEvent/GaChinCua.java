...
/**
 * Boss Gà Chín Cựa - Sự kiện Giỗ Tổ Hùng Vương
 * Drop: Cựa Gà (10-15) + điểm BXH
 */
public class GaChinCua extends Boss {
    ...
    public void afk() {
        if (playerReward != null && playerReward.isPl() && !isReward && this.zone != null) {
            // Drop Cựa Gà 10-15
            ItemMap it = new ItemMap(this.zone, ConstItem.CUA_GA, Util.nextInt(10, 15),
