...
public class NDVSqlFetcher {
    ...
    private static Player loadPlayer(NDVResultSet rs, boolean isOffline) throws Exception {
        ...
        try {
            ...
            player.itemTime.timevevang = timeUsevevang * 60 * 1000;
            ...
            player.playerTask.kolTask.template = TaskService.gI()
                    .getKolTaskTemplateById(Integer.parseInt(dataArray.get(0).toString()));
            ...
            try {
                ...
                if (dataArray.size() > 14) {
                    player.popoTowerFloor = Integer.parseInt(dataArray.get(10).toString());
                    player.popoTowerTodayCount = Integer.parseInt(dataArray.get(11).toString());
                    player.popoTowerLastDay = Long.parseLong(dataArray.get(12).toString());
