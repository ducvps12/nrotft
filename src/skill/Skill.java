...
public class Skill {
    ...
    public static final byte SUPER_TRAI_DAT = 29;
    public static final byte SUPER_NAMEC = 30;
    public static final byte SUPER_SAIYAN = 31;
    public static final byte GONG = 32;
